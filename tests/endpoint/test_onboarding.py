...
@pytest.mark.asyncio
async def test_verify_email_success(client: AsyncClient, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_resend_verification_generates_new_token(client: AsyncClient, auth_headers: dict, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_resend_verification_already_verified(client: AsyncClient, auth_headers: dict, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_forgot_password_sets_token(client: AsyncClient, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_reset_password_success(client: AsyncClient, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_reset_password_expired_token(client: AsyncClient, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_logout_success(client: AsyncClient, auth_headers: dict, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_reactivate_within_30_days(client: AsyncClient, test_user: User, db: AsyncSession):
    ...
    # Assert 200
    # Refresh test_user — assert is_active == True and deactivated_at is None
    pass


@pytest.mark.asyncio
async def test_reactivate_after_30_days_blocked(client: AsyncClient, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_accept_terms(client: AsyncClient, auth_headers: dict, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_consent_location(client: AsyncClient, auth_headers: dict, test_user: User, db: AsyncSession):
...
@pytest.mark.asyncio
async def test_onboarding_status_all_incomplete(client: AsyncClient, auth_headers: dict):
    """A freshly registered user has all onboarding steps incomplete."""
    # GET /api/v1/auth/onboarding-status
    # Assert 200
    # Assert email_verified == False, terms_accepted == False, onboarding_complete == False
    pass


@pytest.mark.asyncio
async def test_onboarding_status_complete(client: AsyncClient, auth_headers: dict, test_user: User, db: AsyncSession):
    ...
    # GET /api/v1/auth/onboarding-status
    # Assert onboarding_complete == True
    pass
